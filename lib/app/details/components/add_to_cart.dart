        ...
        children: <Widget>[
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      backgroundColor: Colors.blue, // Background color updated to pink
                        ...
                        children: <Widget>[
                          ...
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.blue, // Button background color updated to deeper pink
                              shape: RoundedRectangleBorder(
          ...
          Expanded(
            child: ElevatedButton(
              ...
              child: Text(
                "Đéo thêm vào giỏ hàng".toUpperCase(),
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                ),
